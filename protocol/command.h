	...
	enum NET_TCP_CMD
	{
		...
		*/
		...
		/*
			平台框架消息
		*/
		p_cs_frame_join_room_request = cmd_base + 202,
		p_sc_frame_join_room_reply = cmd_base + 1202,

		p_cs_frame_leave_room_request = cmd_base + 203,
		p_sc_frame_leave_room_reply = cmd_base + 1203,
	};
